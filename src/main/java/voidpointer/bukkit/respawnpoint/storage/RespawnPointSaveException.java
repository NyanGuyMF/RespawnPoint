...
final class RespawnPointSaveException extends Exception {
    private static final long serialVersionUID = -6420782899421996887L;

    public RespawnPointSaveException(final Exception superException) {
        super("Unable to save respawn point configuration", superException);
    }
}
