...
final class NoSuchLocationException extends Exception {
    private static final long serialVersionUID = 8715395268202062512L;

    public NoSuchLocationException() {
        this("No such location");
    }

    public NoSuchLocationException(final String message) {
        super(message);
    }
}
